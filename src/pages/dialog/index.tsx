...
const DialogPages = () => {
    ...
    const [isDialogClosedConfirm, setDialogClosedConfirm] = React.useState(true);
...
export const SampleNoDismiss = () => {
    ...
    return <section className="dialog__container">
        ...
        <article className='dialog__container__content__title'>
            ...
            <div>
            <DefaultButton onClick={() => setDialogClosedConfirm(false)}>Open dialog</DefaultButton>
            <Dialog hidden={isDialogClosedConfirm} title="Confirm" maxWidth="480px">
                <div>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem cumque, excepturi, veniam, odit quos eveniet laudantium ea aut amet in est possimus minima rerum explicabo ducimus
                    quisquam optio! Alias, totam?
                </div>
                <DialogFooter>
                    <PrimaryButton onClick={() => setDialogClosedConfirm(true)} text="OK" />
                </DialogFooter>
            </Dialog>
        </div>
            </CodeExample>
